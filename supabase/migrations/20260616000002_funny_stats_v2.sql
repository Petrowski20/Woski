-- ============================================================
--  RPC: get_funny_prediction_stats v2
--  - Parámetro opcional p_league_id para filtrar por liga
--  - Añade missed_by_one (casi exacto) y predicted_draws
-- ============================================================

-- La firma cambió (añadimos parámetro), hay que eliminar la v1
DROP FUNCTION IF EXISTS get_funny_prediction_stats();
...
BEGIN
  WITH detail AS (
    SELECT
      ...
      -- Casi exacto: error total = 1 gol y no fue pleno
