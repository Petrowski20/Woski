-- ============================================================
--  RPC: get_funny_prediction_stats v3
--  Añade: rachas (best/current), rendimiento por confederación,
--  y puntos acumulados por partido para curva de evolución.
-- ============================================================
...
BEGIN
  ...
  -- ── Puntos acumulados partido a partido (para curva de evolución) ──────────
  detail_with_cum AS (
    SELECT
      *,
  ...
  -- Un partido con dos confederaciones distintas cuenta para ambas
  ...
  -- ── Ligas del jugador (siempre globales, independiente del filtro) ─────────
