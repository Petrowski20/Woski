...
// Fallo al cargar el calendario o al cambiar de competición. Nunca se
...
export default function LolError({
  ...
  return (
    <div className="flex flex-col items-center gap-3 py-20 text-center">
      ...
      <h1 className="text-lg font-bold text-text-primary">No hemos podido cargar el calendario</h1>
      <p className="text-sm text-text-muted max-w-sm">
        {offline
          ? 'Parece que no tienes conexión. Comprueba tu red e inténtalo de nuevo.'
          : 'Algo ha fallado al traer los partidos. Suele arreglarse solo: inténtalo de nuevo en unos segundos.'}
      </p>
      <button
        type="button"
